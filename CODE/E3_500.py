...
# EDO da massa (Sistema unidimensional dependente do tempo)
def f_m(t, m):
    r = r_simplificado(t)
    T = T_simplificado(t)
...
# Solução Numérica do Euler para a Massa
massa_euler = euler_explicito_1d(f_m, m_i, tempo)

# Soluções Analíticas para Raio e Temperatura
