...
dt_inicial  = 1e-3      # Inicial
tol         = 1e-3      # Tolerância do erro local
...
fig.suptitle(
    f'Sistema Simplificado Adaptativo - Euler Explícito (E5)\n{len(tempo)} pontos',
    fontsize=13
)
...
# dt
ax4.semilogx(tempo, dts, '-', color='#0D00FF', lw=2, ms=4,
